...
int main()
{
    ...
    vi_exp->add_primitive(DQ_CoppeliaSimInterfaceZMQ::PRIMITIVE::SPHEROID, robotname, {0.2, 0.2, 0.2});
    ...
    for (int i=0; i<200; i++)
    {
        ...
        vi_exp->set_twist(robotname, twist_b,
                          DQ_CoppeliaSimInterfaceZMQ::REFERENCE::BODY_FRAME);

        std::cout<<"twist_a :    "<<twist_a<<std::endl;
        std::cout<<"twist_a_:    "<<vi_exp->get_twist(robotname)<<std::endl;
        std::cout<<" "<<std::endl;
        std::cout<<"twist_b :    "<<twist_b<<std::endl;
        std::cout<<"twist_b_:    "<<vi_exp->get_twist(robotname, DQ_CoppeliaSimInterfaceZMQ::REFERENCE::BODY_FRAME)<<std::endl;
